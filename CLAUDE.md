...
| `backpay-2026` | `index.html` | Back pay arrives 28 August | 💷 Pay | 21 Aug 2026 | **Hard cutoff: Thu 27 Aug 2026 · 23:00** (a clock time, not a day count — the eve of the award payslip; past it the notice self-retires silently) | ✅ live for the last few hours — the cutoff is **tonight, 27 Aug 2026 · 23:00**, after which it self-retires and this row becomes ⛔ inert. Checked at the v21.90 sweep, on the day. Remove from code+table on the 180-day rule ~17 Feb 2027 | One-shot; `myb_notice_backpay_2026_done` set on close AND on the CTA — no snooze |
