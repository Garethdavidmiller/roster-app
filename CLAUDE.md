...
│   ├── visual-baselines/   ← committed baseline PNGs for visual.spec.js (15 — 10 page surfaces, 3 OVERLAYS added v19.03, the populated Operations Usage card added v19.25, generated in the dev-container headless Chromium). Regenerate wholesale if the rendering environment (browser/OS/font stack) changes
