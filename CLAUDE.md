...
│   ├── visual-baselines/   ← committed baseline PNGs for visual.spec.js (16 — 10 page surfaces, 3 OVERLAYS added v19.03, the populated Operations Usage card v19.25, the roster review table v19.34, generated in the dev-container headless Chromium). Regenerate wholesale if the rendering environment (browser/OS/font stack) changes
