...
<section class="page cover">
  ...
  <div class="sub">${meta.sub1 ?? (BB ? 'A 24-line link built from the December 2026 staffing rules and judged on the ORR fatigue factors — nothing carried over from today’s roster except the rules' : B2 ? 'The December 2026 timetable rules with no duty over 8h40 and the ticket office written in — two 14:00–22:30 turns a day Monday to Saturday, two 13:30–22:00 on a Sunday — judged on the ORR fatigue factors' : EF ? 'A 24-line link built from the December 2026 staffing rules with no duty over 8h40, judged on the ORR fatigue factors — nothing carried over from today’s roster except the rules' : PT ? 'Today’s roster, widened to 24 people and built to the owner’s pinned turns — 15:45 closers, three 06:20–14:20 openers and two 14:00–22:30 lates Monday to Friday, nothing over 8h40 — with the rest of each day fitted to the December 2026 timetable' : Q2 ? 'The existing 20-line link, widened to 24 people, with the closing turn at 15:45 and Saturday and Sunday rebuilt so that nothing runs over 8h40 — the same shape of week, one more cover cycle' : QT ? 'The existing 20-line link, widened to 24 people, with the closing turn starting at 15:45 — the same shape of week, one more cover cycle, and one turn a little longer to keep the contract' : 'The existing 20-line link, widened to 24 people — the same turns, the same shape of week, one more cover cycle')}</div>
  ...
  <div class="tiles">
    ${BB ? `<div class="tile"><b>${P.feel.distinctTimes} turns</b><span class="l">in the December 2026 duty table</span><span class="s">searched against the timetable; lates shorter than earlies; on the quarter hour except the open and close</span></div>`
         ...
         : PT ? `<div class="tile"><b>${sharedTimes} of ${P.feel.distinctTimes}</b><span class="l">shift times are today's</span><span class="s">the ${newTimes.length} that are not: ${newTimes.join(', ')} — the brief's own turns and the fitted middles</span></div>`
