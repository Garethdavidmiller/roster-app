...
<section class="page cover">
  ...
  <div class="sub">${meta.sub1 ?? (BB ? 'A 24-line link built from the December staffing rules and judged on the ORR fatigue factors — nothing carried over from today’s roster except the rules' : 'The existing 20-line link, widened to 24 people — the same turns, the same shape of week, one more cover cycle')}</div>
...
<section class="page">
  <div class="mast"><div><div class="eyebrow">${meta.eyebrow3 ?? (BB ? "The December table" : "Today's link, widened")}</div><h1>${meta.h3 ?? (BB ? "How a week compares with today" : "Same feel, more people")}</h1><div class="sub">${meta.sub3 ?? (BB ? "Nothing here was asked to resemble today's roster; this is how close the fatigue factors took it on their own, and where the December table differs" : "What the search was told to keep, and what the December headcounts made it change")}</div></div></div>
  <div class="stack">
  ...
  ${feelRow(`Distinct shift times <span class="muted">(${BB ? 'none on today’s roster' : 'all already on today’s roster'})</span>`, `${T.feel.distinctTimes}`, `${P.feel.distinctTimes}`)}
  ...
  : `<h2>The duty table, in today's times</h2>
  ...
  <div class="foot"><span>Page 3 of 8 — ${BB ? "How a week compares with today" : "Same feel, more people"}</span><span class="foot-id"><b>${esc(meta.identity.name)}</b> · ${esc(meta.identity.code)} · ${esc(meta.identity.fingerprint)} · Marylebone Roster — Links designer</span></div>
</section>
