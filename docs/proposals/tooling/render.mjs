...
<section class="page cover">
  ...
  <div class="sub">${BB ? 'A 24-line link built from the December staffing rules and judged on the ORR fatigue factors — nothing carried over from today’s roster except the rules' : 'The existing 20-line link, widened to 24 people — the same turns, the same shape of week, one more cover cycle'}</div>
...
<section class="page">
  <div class="mast"><div><div class="eyebrow">${BB ? "The December table" : "Today's link, widened"}</div><h1>${BB ? "How a week compares with today" : "Same feel, more people"}</h1><div class="sub">${BB ? "Nothing here was asked to resemble today's roster; this is how close the fatigue factors took it on their own, and where the December table differs" : "What the search was told to keep, and what the December headcounts made it change"}</div></div></div>
  <div class="stack">
