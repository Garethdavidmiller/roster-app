...
<section class="page">
  <div class="mast"><div><div class="eyebrow">Method</div><h1>${meta.h7 ?? 'How it was chosen, and how to load it'}</h1><div class="sub">${meta.sub7 ?? 'Reproducible: the same table, seed and objective give the same grid on any machine'}</div></div></div>
  <div class="cols"><div>
