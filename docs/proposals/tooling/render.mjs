...
<section class="page">
  <div class="mast"><div><div class="eyebrow">${meta.eyebrow3 ?? (BB ? "The December 2026 duty table" : B2 ? "The December 2026 duty table, capped at 8h40, the ticket office rostered" : EF ? "The December 2026 duty table, capped at 8h40" : Q2 ? "Today's link, widened — the closer at 15:45, the weekend rebuilt" : QT ? "Today's link, widened — the closer at 15:45" : "Today's link, widened")}</div><h1>${meta.h3 ?? (RULES ? "How a week compares with today" : QT ? "Same feel, later closer" : "Same feel, more people")}</h1><div class="sub">${meta.sub3 ?? (RULES ? "Nothing here was asked to resemble today's roster; this is how close the fatigue factors took it on their own, and where the December 2026 duty table differs" : Q2 ? "What the search was told to keep, what the December 2026 headcounts made it change, the two openers that run on to pay for the later start, and a weekend searched under the cap rather than inherited" : QT ? "What the search was told to keep, what the December 2026 headcounts made it change, and the two openers that run on to pay for the later start" : "What the search was told to keep, and what the December 2026 headcounts made it change")}</div></div></div>
  <div class="stack">
  ...
  : `<h2>${Q2 ? "The duty table — today's times, the closer at 15:45, Saturday and Sunday rebuilt" : QT ? "The duty table — today's times, the closer at 15:45" : "The duty table, in today's times"}</h2>
  ...
  <p class="muted">${meta.dutyNote ?? `Why the extra duties land where they do: a weekday needs 6,980 minutes and a Saturday 7,100 for 5 weekdays + 1 Saturday to total exactly 20 × 35h = 42,000 — an equality, so the table is one of the few combinations of today's turn lengths that reaches it to the minute. ${Q2 ? "Today's three weekday openers — 06:20–13:35, 06:20–13:45 and 06:20–14:20 — fold into Saturday's two, 06:20–14:00 and 06:20–14:50, as in <i>Quarter To</i>. The Sat and Sun columns are SEARCHED tables, not today's: every duty 7h–8h40, on the quarter hour or a clock time somebody works today, with the day's headcounts and minutes held (page 8, step 1)." : QT ? "Today's three weekday openers — 06:20–13:35, 06:20–13:45 and 06:20–14:20 — fold into Saturday's two, 06:20–14:00 and 06:20–14:50; Sunday gains an 11:00–19:30 middle turn from the weekday vocabulary." : "The 06:20–13:35 turn is folded into 06:20–13:45 (ten minutes, one fewer time to remember); Sunday gains an 11:00–19:30 middle turn from the weekday vocabulary."}`}</p></div>
  </div>`}
