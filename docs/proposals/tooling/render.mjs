...
<section class="page">
  <div class="mast"><div><div class="eyebrow">${meta.eyebrow3 ?? (BB ? "The December table" : EF ? "The December table, capped at 8h40" : QT ? "Today's link, widened — the closer at 15:45" : "Today's link, widened")}</div><h1>${meta.h3 ?? (RULES ? "How a week compares with today" : QT ? "Same feel, later closer" : "Same feel, more people")}</h1><div class="sub">${meta.sub3 ?? (RULES ? "Nothing here was asked to resemble today's roster; this is how close the fatigue factors took it on their own, and where the December table differs" : QT ? "What the search was told to keep, what the December headcounts made it change, and the two openers that run on to pay for the later start" : "What the search was told to keep, and what the December headcounts made it change")}</div></div></div>
  <div class="stack">
