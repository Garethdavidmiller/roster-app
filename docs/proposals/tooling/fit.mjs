...
// Q and R (12 Sep 2026): table B with the closer at 15:45 and NO duty over 8h40 — the contract kept by
// running the two 06:20 openers on: Q to Saturday's own opener times (14:00 and 14:50), R to 14:30. See table-late.mjs
const WKQ=[['06:20-14:00',2],['06:20-14:50',2],['08:00-16:30',3],['13:30-22:00',2],['14:00-22:30',2],['15:45-23:55',3]];
const WKR=[['06:20-14:30',2],['06:20-14:20',2],['08:00-16:30',3],['13:30-22:00',2],['14:00-22:30',2],['15:45-23:55',3]];
const WKS=[['06:20-14:15',2],['06:20-14:35',2],['08:00-16:30',3],['13:30-22:00',2],['14:00-22:30',2],['15:45-23:55',3]];
...
for (const [n,d] of [['today wk',TODAYWK],['A',WKA],['B',WKB],['C',WKC],['D',WKD],['Q',WKQ],['R',WKR],['S (not searched)',WKS]]) console.log('weekday', n.padEnd(9), JSON.stringify(fit('weekday',d)));
