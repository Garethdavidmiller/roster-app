...
- **Links compare on a phone — self-labelling cells: DECLINED** (v22.70, external review). The
...
- **Links sticky save bar — density pass: DECLINED** (v22.70, external review). Nothing is reported
