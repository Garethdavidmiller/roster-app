import { CONFIG, teamMembers, DAY_KEYS, DAY_NAMES, MONTH_ABB, getALEntitlement, getSpecialDayBadges, getShiftBadge, getWeekNumberForDate, getRosterForMember, getBaseShift, escapeHtml, formatISO, isSunday, SWIPE_THRESHOLD, SWIPE_VELOCITY } from './roster-data.js?v=6.99';
import { db, collection, query, where, orderBy, limit, getDocs, addDoc, deleteDoc, doc, setDoc, getDoc, serverTimestamp, writeBatch, uploadHuddle } from './firebase-client.js?v=6.99';
...
// Run window.bulkSuspendLewis() from the browser console on admin.html
// once to create all overrides, then this function can be removed.
// ============================================
window.bulkSuspendLewis = async function() {
    ...
    await batch.commit();
    console.log(`[bulkSuspendLewis] Created ${count} overrides for ${memberName} (1 Jan – 31 May 2026)`);
    alert(`Done — ${count} overrides created for ${memberName}.`);
};
