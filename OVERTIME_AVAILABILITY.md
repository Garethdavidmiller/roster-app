...
The eligible population comes from `functions/roster-members.json` (`overtimeEligibleMembers`,
generated by `npm run generate:roster-members` — never hand-edited, CI-locked). A new starter is
therefore invisible to this feature until that file is regenerated, exactly as they are to roster
import.
