...
| ID | Guide | Section | Class | Reviewed | Next | Source |
|----|-------|---------|-------|----------|------|--------|
| rr-shakespeare | rangers | Shakespeare Explorer — 1 or 4 day return, Marylebone to Leamington Spa/Warwick/Warwick Parkway and all stations to Stratford-upon-Avon; unlimited travel Leamington Spa–Stratford; not valid for return trains due into Marylebone before 10:00 Mon–Fri. **OPEN (v20.08, external review): BREAK OF JOURNEY IS UNRESOLVED** — the guide asserted it was allowed Marylebone–Leamington Spa, and the review found National Rail's own page contradicting itself. Each reading refuses somebody (a passenger charged who should not be, or one penalised for a stop-off made in good faith), so the card now states it as unresolved and refers it. Resolve at the next review | Draft | 2026-08 | 2026-11 | https://www.nationalrail.co.uk/ticket-types/tickets/sh1/ |
...
| rr-all-line | rangers | All Line Rover — 7 or 14 consecutive days; the **National Rail network** across GB, **excluding** Eurostar, Heathrow Express, the Underground, DLR, trams, shipping services and heritage railways (v20.08 — the guide said "all of Great Britain", which answers an Underground question confidently and wrongly, even though none of the exclusions is Chiltern). Stations sell it up to **3 days** before the start date; further ahead goes via **telesales or online**, reported as up to **5 days**. A before-10:00 Mon–Fri bar applies on some long-distance operators | Draft | 2026-08 | 2026-11 | https://www.nationalrail.co.uk/ticket-types/tickets/r07/ |
| rr-cotswolds | rangers | Cotswolds Discoverer — NOT valid on Chiltern (every source agrees), though its area includes Oxford, Kingham, Charlbury and Moreton-in-Marsh. **OPEN (v20.08, external review): WHICH operators it names is inconsistent between sources** — the guide listed CrossCountry, GWR and TfW. The Chiltern answer does not depend on it, so the card keeps the refusal and stops quoting the list. Resolve at the next review | Draft | 2026-08 | 2026-11 | https://www.nationalrail.co.uk/ticket-types/tickets/ce1/ |
