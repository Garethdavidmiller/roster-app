...
// Pay lightbox — coming-soon panel
(function () {
    ...
    document.getElementById('payBtn').addEventListener('click', openPayLightbox);
...
(async function initHuddleButton() {
    ...
    try {
        ...
        if (!huddle) {
            btn.disabled = true;
            btn.title = 'No briefing today';
            btn.setAttribute('aria-label', 'Huddle — no briefing today');
            return;
        }
