    ...
    for (let day = 1; day <= daysInMonth; day++) {
        ...
        if (isCutoffDate(currentDate)) {
            ...
            dayCell.addEventListener('click', () => {
                ...
                paydayDate.setDate(paydayDate.getDate() + 6);
...
(function initHuddleViewer() {
    ...
    const _autoOpen = window.location.hash === '#huddle';
