 ...
 * already recorded for the payslip fixture (AUTH_ARCHITECTURE.md → PAYSLIP_ACTUALS) — which is why
 * that file left the repository altogether at v23.71 rather than relying on this list:
