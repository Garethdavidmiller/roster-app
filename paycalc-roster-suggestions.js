...
import { teamMembers, getBaseShift, formatISO, getBankHolidays } from './roster-data.js?v=9.18';
import { db, collection, query, where, getDocs } from './firebase-client.js?v=9.18';
