...
- Tested by `paycalc-hpp-schedule.test.mjs` — including the **round-trip invariant** (carrier → tax year → carrier) against the REAL tax-year table, the assertion that would have caught v18.84
