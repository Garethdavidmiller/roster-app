...
const NETWORK_FIRST_FILES = [
    ...
    'admin-al.js', 'al-entitlement.js', 'admin-al-year.js', 'admin-al-spare-note.js', 'al-swapped-days.js', 'admin-booked-periods.js', 'admin-sick.js', 'admin-range-booking.js', 'admin-week-swipe.js',
