...
const NETWORK_FIRST_FILES = [
    ...
    'roster-data.js', 'date-format.js', 'roster-cycle-data.js', 'roster-member-data.js', 'firebase-client.js', 'claim-retry.js', 'storage-utils.js', 'storage-keys.js', 'status-text.js', 'upload-commit.js', 'doc-retention.js', 'documents-client.js', 'auth-identity.js', 'client-errors.js',
    'shared.css',
