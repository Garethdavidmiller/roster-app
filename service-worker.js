...
const NETWORK_FIRST_FILES = [
    ...
    'admin-roster-upload.js', 'admin-overrides.js', 'admin-override-store.js', 'admin-override-coverage.js', 'admin-shift-types.js', 'admin-week-editor.js', 'admin-saved-changes.js', 'admin-shift-rules.js', 'admin-save-receipt.js', 'admin-tasks.js', 'admin-rangepicker.js',
