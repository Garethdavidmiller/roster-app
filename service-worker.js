// MYB Roster — Service Worker v6.55
// Strategy:
...
const NETWORK_FIRST_FILES = ['index.html', 'admin.html', 'app.js', 'admin-app.js', 'roster-data.js', 'firebase-client.js', 'shared.css', 'paycalc.html', 'paycalc.js'];
