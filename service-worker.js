...
const NETWORK_FIRST_FILES = [
    ...
    'admin-al.js', 'admin-al-projection.js', 'al-entitlement.js', 'admin-al-year.js', 'admin-al-spare-note.js', 'al-swapped-days.js', 'admin-booked-periods.js', 'admin-sick.js', 'admin-range-booking.js', 'admin-week-swipe.js',
    'operations-app.js', 'operations-boot.js', 'operations-reports.js', 'operations-errors.js', 'operations-usage.js', 'operations-speed.js', 'operations-attention.js', 'settings-app.js', 'settings-boot.js', 'overtime-app.js', 'overtime-boot.js', 'overtime-data.js', 'overtime-format.js', 'overtime-phase.js', 'overtime-sunday-release.js', 'overtime-clock.js', 'overtime-tips.js', 'overtime-form.js', 'overtime-roster.js', 'overtime-manager.js', 'overtime-review-controller.js', 'password-force.js', 'links-app.js', 'links-boot.js', 'links-design.js', 'links-seed.js', 'links-default-targets.js', 'links-target-sets.js', 'links-target-sets-store.js', 'links-target-hours.js', 'links-tips.js', 'links-design-doc.js',
    ...
    'roster-data.js', 'roster-cycle-data.js', 'roster-member-data.js', 'firebase-client.js', 'claim-retry.js', 'storage-utils.js', 'storage-keys.js', 'status-text.js', 'upload-commit.js', 'doc-retention.js', 'documents-client.js', 'auth-identity.js', 'client-errors.js',
    'shared.css',
...
const CORE_ASSETS = [
    ...
    "./guide-index.js",
    "./install-prompt.js",
    "./calendar-notif-prompt.js",
    "./calendar-doc-access.js",
    "./calendar-lock-slot.js",
    "./text-scale.js",
    "./notif.js",
    "./shared.css",
    "./manifest.json",
...
const SAFE_NOTIFICATION_PAGES = ['', 'index.html', 'paycalc.html', 'operations.html', 'overtime.html', 'settings.html'];
