...
const NETWORK_FIRST_FILES = [
    ...
    'operations-app.js', 'operations-boot.js', 'operations-reports.js', 'settings-app.js', 'settings-boot.js', 'password-force.js', 'links-app.js', 'links-boot.js', 'links-design.js', 'links-concurrency.js', 'links-deletion.js', 'links-fatigue.js', 'links-analysis.js', 'links-compare.js',
