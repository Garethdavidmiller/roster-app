...
const NETWORK_FIRST_FILES = [
    ...
    'links-design-naming.js', 'links-design-header.js', 'links-generator-targets.js', 'links-design-store.js', 'links-import.js', 'links-concurrency.js', 'links-deletion.js', 'links-fatigue.js', 'links-compare-analysis.js', 'links-limits.js', 'links-window.js', 'links-demand.js', 'links-adjacency.js', 'links-analysis.js', 'links-compare.js',
    ...
    'roster-data.js', 'date-format.js', 'roster-cycle-data.js', 'roster-member-data.js', 'firebase-client.js', 'claim-retry.js', 'storage-utils.js', 'document-url.js', 'storage-keys.js', 'status-text.js', 'upload-commit.js', 'doc-retention.js', 'documents-client.js', 'auth-identity.js', 'client-errors.js',
    'shared.css',
