...
export const HELP_CONTENT = {
  ...
  accuracy: {
    ...
    tips: [
      ...
      'These figures are <strong>one</strong> running total from your latest payslip, shared across the year, so the estimate is sharpest for the <strong>next</strong> period. The note at the top of the card names the payslip whose figures fit the period you\'re viewing best — keep the one total updated as new payslips arrive.',
    ],
  },
  hpp: {
  ...
  backpay: {
    ...
    tips: [
      ...
      'For a <strong>confirmed</strong> award the old and new rates are filled in and fixed, and the lump lands on the right payslip automatically. For a <strong>past</strong> year you can instead enter the exact amount printed on your payslip. Only a future award that\'s agreed but not yet on payslips shows an editable estimate.',
