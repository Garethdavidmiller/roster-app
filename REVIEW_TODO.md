...
- [x] **B1** named-session separation — **ENABLED v14.42** (`ENFORCE_NAMED_SESSION = true`) after the
  owner provisioning audit. Kill-switch revert = flip back to false (one-line deploy).
