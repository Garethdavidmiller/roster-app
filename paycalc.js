...
import { APP_VERSION, CONFIG as ROSTER_CONFIG, teamMembers, getBaseShift, formatISO, escapeHtml } from './roster-data.js?v=9.60';
import {
...
} from './paycalc-calc.js?v=9.60';
import { resetOverrides, getOverridesFetchState, fetchOverridesForPeriod, getRosterSuggestion, bhsForYear } from './paycalc-roster-suggestions.js?v=9.60';
'use strict';
...
const MILLER_ACTUALS = {
  ...
  '2025-06-06': { gross: 4340.23, tax:  769.34, ni: 241.46, sl: 210.00, net: 3119.60, varPay: 1692.94 },
  ...
  '2025-12-19': { gross: 5245.44, tax: 1131.20, ni: 259.60, sl:   0,    net: 3854.67, varPay: 2496.61 },
