...
import { APP_VERSION, CONFIG as ROSTER_CONFIG, teamMembers, getBaseShift, formatISO, escapeHtml, getBankHolidays } from './roster-data.js?v=9.22';
import {
...
} from './paycalc-calc.js?v=9.22';
import { resetOverrides, getOverridesFetchState, fetchOverridesForPeriod, getRosterSuggestion } from './paycalc-roster-suggestions.js?v=9.22';
'use strict';
...
const MILLER_ACTUALS = {
  ...
  '2025-06-06': { gross: 4340.23, tax:  769.22, ni: 241.46, sl: 210.00, net: 3119.57, varPay: 1692.94 },
