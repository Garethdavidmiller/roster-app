...
import { APP_VERSION, CONFIG as ROSTER_CONFIG, teamMembers, getBaseShift, formatISO, escapeHtml } from './roster-data.js?v=9.65';
import {
...
} from './paycalc-calc.js?v=9.65';
import { resetOverrides, getOverridesFetchState, fetchOverridesForPeriod, getRosterSuggestion, bhsForYear } from './paycalc-roster-suggestions.js?v=9.65';
'use strict';
...
const MILLER_ACTUALS = {
  ...
  '2025-06-06': { gross: 4340.23, tax:  769.34, ni: 241.46, sl: 210.00, net: 3119.65, varPay: 1692.94 },
  '2025-07-04': { gross: 4883.78, tax:  986.40, ni: 252.33, sl: 259.12, net: 3386.05, varPay: 2236.49 },
  '2025-08-01': { gross: 4441.60, tax:  809.65, ni: 243.49, sl: 219.00, net: 3169.51, varPay: 1789.80 },
  ...
  '2025-12-19': { gross: 5245.44, tax: 1131.20, ni: 259.65, sl:   0,    net: 3854.67, varPay: 2496.61 },
