import { APP_VERSION, CONFIG as ROSTER_CONFIG, teamMembers, getBaseShift, formatISO, escapeHtml } from './roster-data.js?v=7.43';
import { db, collection, query, where, getDocs } from './firebase-client.js?v=7.43';
'use strict';
