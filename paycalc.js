...
import { APP_VERSION, CONFIG as ROSTER_CONFIG, teamMembers, getBaseShift, formatISO, escapeHtml, getBankHolidays } from './roster-data.js?v=8.87';
import {
...
} from './paycalc-calc.js?v=8.87';
import { resetOverrides, getOverridesFetchState, fetchOverridesForPeriod, getRosterSuggestion } from './paycalc-roster-suggestions.js?v=8.87';
'use strict';
...
const MILLER_ACTUALS = {
  ...
  '2026-02-13': { gross: 5188.87, tax: 1108.40, ni: 258.44, sl:   0,    net: 3822.00, varPay: 2440.02 },
...
function loadSettings() {
  ...
  // Migration (v8.87): two-part pension localStorage cleanup.
  //
  ...
  //   ANCHOR_DATE was midnight before v8.87; it must be noon to maintain the
