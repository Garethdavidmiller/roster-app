...
import { APP_VERSION, CONFIG as ROSTER_CONFIG, teamMembers, getBaseShift, formatISO, escapeHtml, getBankHolidays } from './roster-data.js?v=9.09';
import {
...
} from './paycalc-calc.js?v=9.09';
import { resetOverrides, getOverridesFetchState, fetchOverridesForPeriod, getRosterSuggestion } from './paycalc-roster-suggestions.js?v=9.09';
'use strict';
...
const MILLER_ACTUALS = {
  ...
  '2025-07-04': { gross: 4883.78, tax:  986.40, ni: 252.33, sl: 259.09, net: 3386.05, varPay: 2236.49 },
  '2025-08-01': { gross: 4441.60, tax:  809.60, ni: 243.49, sl: 219.09, net: 3169.51, varPay: 1789.80 },
