...
import { APP_VERSION, CONFIG as ROSTER_CONFIG, teamMembers, getBaseShift, formatISO, escapeHtml, getBankHolidays } from './roster-data.js?v=8.84';
import {
...
} from './paycalc-calc.js?v=8.84';
import { resetOverrides, getOverridesFetchState, fetchOverridesForPeriod, getRosterSuggestion } from './paycalc-roster-suggestions.js?v=8.84';
'use strict';
...
function loadSettings() {
  ...
  // Migration (v8.84): two-part pension localStorage cleanup.
  //
  ...
  //   ANCHOR_DATE was midnight before v8.84; it must be noon to maintain the
